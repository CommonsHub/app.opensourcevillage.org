...
NFC tags contain URL: `app.opensourcevillage.org/badge#{serialNumber}` (serialNumber in fragment, stays client-side)
...
- Client derives NOSTR keypair from serialNumber + password
- Backend uses npub as identifier (serialNumber never leaves device)
...
They can make two types of offers:
